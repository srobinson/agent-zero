...
def create_conversation_agent():
    """Create a simple conversation agent using Anthropic."""
    try:
...
def main():
    print("=== Simple Streaming Conversation with Anthropic Example ===")
    print(
        "This example demonstrates a basic back-and-forth conversation with an agent using Anthropic's Claude model and streaming responses.\n"
    )
